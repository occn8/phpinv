...
<body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4">Update Product Store</h1>
    ...
    <div class="container">
        ...
        <!-- <center> -->
                ...
                <?php include('errors.php'); ?>
                    ...
                    <input type="text" name="currentstore" id="old" class="mb-3 form-control"><br>
                    <label for="new" class="white"><b>New Store</b></label>
                    <input type="text" name="newstore" id="new" class="mb-3 form-control"><br>
